...
export default class NavMenu extends Component {
  constructor(props) {
    ...
    this.displayAboutTech         = this.displayAboutTech.bind(this);
      ...
      <div>
        ...
        <div className="MainView" style={{"overflow": "scroll"}}>
          ...
          <p className="TextBody">
            ...
            I'm serving up items from our small but growing menu. Some selections should, I hope,
            whet your appetite to learn more about technical proficiencies I have. Others are a light dessert 
          </p><br/>
          <p className="TextBody">
            May I give you a quick overview of the menu?
            <ul>
              <li>Living Water - the Gospel of Jesus Christ is by far the greatest and most satisfying selection here. </li>
              ...
              <li>A Chiffon au Fond: The Virtual Support menu item describes an idea for supporting software product customers in a virtual space.</li>
              <li>Ice Cream/Cookies: The Childlike Homepage item is a rendering from memory of a delightful homepage I saw many years ago.</li>
            </ul>
          </p>
          <p className="TextBody">
  ...
  displayAboutTech(event) {
    this.reactDomRender (
      <div>
        <TopBar className="TopBar" displayHeading={true}/>
        <NavMenu/>
        <div className="MainView" style={{"overflow": "scroll"}}>
          <h1 className="PageHeading">About The Technology</h1>
          <p className="TextBody">
            Here is an overview of the technology used in KPS Portfolio.
            <ul>
              <li>All source code for the web site and the demos is in Github.</li>
      ...
      <div>
        ...
        <div className="MainView" style={{"overflow": "scroll"}}>
          <div style={{"content": "", "display": "table", "clear": "both"}}>
            ...
            <div style={{"float": "left", "width": "25%", "margin": "0 0 0 20px"}}>
              <p className="TextBodyColumn">
            ...
            <div style={{"float": "left", "width": "70%"}}>
              <img src={require("./Images/ChildlikeHomepage.png")} width="828px" height="500px" style={{"border-style": "solid", "border-width": "3px", "border-color": "dark gray"}} usemap="#clhpmap"/>
              <div>
                <map name="clhpmap">
                  ...
                  <span clhp-tooltip="And clouds go with the sun."><area shape="rect" coords="275,25,575,215" href="https://www.google.com" alt="House"/></span>
                  <span clhp-tooltip="A home for the homepage."><area shape="rect" coords="650,75,800,300" href="https://www.google.com" alt="House"/></span>
                  <span clhp-tooltip="Must have flowers."><area shape="rect" coords="500,250,650,300" href="https://www.google.com" alt="House"/></span>
                  <span clhp-tooltip="24 is good age."><area shape="rect" coords="600,375,750,475" href="https://www.google.com" alt="Signature"/></span>
  ...
  render() {
    return(
      <div className="NavMenu">
        ...
        <div>&nbsp;</div>
        <div>&nbsp;<i className="far fa-folder" style={{"color": "#ffffff"}}>&nbsp;&nbsp;</i><a href="javascript:void(0)" onClick={this.displayAboutTech}>About Tech</a></div>
        <div>&nbsp;</div>
